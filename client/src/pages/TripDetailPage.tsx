                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{
                    __html: suggestionsMutation.data.suggestions
                      .replace(/\n\n/g, '<br/><br/>')
                      .replace(/Day \d+:/g, (match: string) => `<h2 class="text-2xl font-medium mt-6 dark:text-white">${match}</h2>`)
                      .replace(/^(Morning|Afternoon|Evening|Late Morning|Lunch|Dinner):/gm, (match: string) => `<h3 class="text-base font-medium mt-4 dark:text-white">${match}</h3>`)
